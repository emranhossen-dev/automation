...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  }, [geminiKey, fbConfig, businessInfo]);
  ...
  return (
    <div className="tab-settings-container card-glass full-width-card">
      <div className="settings-header-row">
        <div>
          <h2>API & Store Settings</h2>
          <p>Configure your Store Details, Gemini AI Key, and Facebook Page Access Tokens directly below.</p>
        </div>
      ...
      <div className="settings-body-inline">
        ...
        <div className="settings-section">
          ...
          <p className="section-desc">
            Enter your Facebook Page ID and Page Access Token for 1-click direct publishing.
          </p>
        ...
        <div className="settings-footer-row" style={{ marginTop: '1.5rem', display: 'flex', justifyContent: 'flex-end' }}>
          <button className="btn-primary" onClick={handleSaveAll}>
            <Save size={16} />
            <span>Save Settings</span>
          </button>
